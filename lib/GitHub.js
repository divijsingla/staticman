...
class GitHub extends GitService {
  constructor (options = {}) {
    ...
    console.log('GitHub.js constructor options:', Object.keys(options));
    ...
    return (async () => {
      ...
      // Log what config values are present
      console.log('GitHub.js config.get("githubToken"):', config.get('githubToken') ? '[set]' : '[not set]');
      console.log('GitHub.js options.oauthToken:', options.oauthToken ? '[set]' : '[not set]');
      console.log('GitHub.js isLegacyAuth:', isLegacyAuth);
      ...
      if (options.oauthToken) {
        ...
        // Log the full options object before throwing
        console.log('ERROR: No token found. options:', options);
        throw new Error('Require an `oauthToken` or `token` option')
      }

      // Log what token is actually being used
      console.log('GitHub.js using authToken:', authToken ? '[set]' : '[not set]');
